...
cout << endl << "replacng GDP with KGB in ms1" << endl;
cout << "should be false again: " << ms1.replace("GDP", "KGB");


cout << endl << "replacng KGB with XYZ in ms1" << endl;
ms1.replace("KGB", "XYZ");
cout << endl << "--------ms1---------" << endl;
for (int i = 0; i < ms1.uniqueSize(); i++)
{
...
void test11()
{
	...
	Multiset ms3(ms2);
	cout << "--------ms3 copy ms2---------" << endl;
	for (int i = 0; i < ms3.uniqueSize(); i++)
	{
		ItemType value;
		ms3.get(i, value);
		cout << value << " count#: " << ms3.count(value) << endl;
	}
	cout << "ms3 unique size: " << ms3.uniqueSize() << endl;
	cout << "ms3 size: " << ms3.size() << endl << endl;
	cout << "ms3: smallest value is " << ms3.getSmallestValue(value);
	cout << " and value is " << value << endl;
	cout << "ms3: second smallest value is " << ms3.getSecondSmallestValue(value);
	cout << " and value is " << value << endl;
	cout << "--------ms3 assignment ms1---------" << endl;
	ms3 = ms1;
	for (int i = 0; i < ms3.uniqueSize(); i++)
	{
		ItemType value;
...
void test12()
{
	...
	ItemType v[6] = { 434234, 324234234, 2342343242, 436456, 675687, 26356346 };
...
void test15()
{
	...
	cout << "----------------erase test at last index-----------------" << endl;
	ms2.get(199, value);
	cout << value << " count#: " << ms2.count(value) << endl;
	ms2.erase(99);
	ms2.get(199, value);
